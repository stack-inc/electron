...
#ifndef SHELL_BROWSER_UI_COCOA_NATIVE_SCROLL_VIEW_IMPL_H_
#define SHELL_BROWSER_UI_COCOA_NATIVE_SCROLL_VIEW_IMPL_H_
...
class NativeScrollViewImpl : public NativeContainerViewImpl {
 public:
  explicit NativeScrollViewImpl(NativeScroll* scroll);
 ...
 private:
  ScrollBarMode GetScrollBarMode(NativeScroll::Policy policy);

  NativeScroll* scroll_;
...
#endif  // SHELL_BROWSER_UI_COCOA_NATIVE_SCROLL_VIEW_IMPL_H_
